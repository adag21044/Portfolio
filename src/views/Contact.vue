  ...
  <div>
    ...
    <ul>
      ...
      <li>
        ...
        <a href="mailto:my@email.com" target="_blank">ahmetedag9@gmail.com</a>
      </li>
      <li>
        <i class="fa fa-linkedin fa-lg fa-fw" style="vertical-align: -5%;"></i>
        <a href="https://www.linkedin.com/me" target="_blank">linkedin.com/in/adag21044/</a>
      </li>
      <li>
        <i class="fa fa-github fa-lg fa-fw"></i>
        <a href="https://github.com/me" target="_blank">github.com/adag21044</a>
      </li>
      <li>
        <i class="fa fa-gamepad fa-lg fa-fw"></i>
        <a href="https://myself.itch.io" target="_blank">adag21044.itch.io/</a>
      </li>
    </ul>
